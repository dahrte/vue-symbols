...
<template>
  <DropdownMenuItem
    ...
    :class="
      cn(
        'col-span-full grid grid-cols-subgrid items-center gap-2 rounded-md px-2.5 py-1.5 text-left text-sm/5 text-content-strong outline-none select-none data-highlighted:bg-surface-hover *:data-[slot=label]:col-start-2',
