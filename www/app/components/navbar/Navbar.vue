...
const { total: totalFiles } = useIcons('files')
const { total: totalFolders } = useIcons('folders')
...
const placeholder = computed(() => {
  return route.path === '/'
    ? `Search ${totalFiles.value} file icons...`
    : `Search ${totalFolders.value} folder icons...`
})
</script>
