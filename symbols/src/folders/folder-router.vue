<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M14 14.625V12H16.625M20.125 12H22.75V14.625"
      stroke="#16A34A"
      stroke-width="1.7"
    ...
    />
    <path
      d="M14 12L17.8622 15.8622C18.1905 16.1904 18.3749 16.6354 18.375 17.0995M18.375 17.0995V20M18.375 17.0995C18.3751 16.6354 18.5595 16.1904 18.8877 15.8622L22.75 12"
      stroke="#16A34A"
      stroke-width="1.7"
      stroke-linecap="round"
      stroke-linejoin="round"
