<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#64748B"
    />
    <circle cx="19.3872" cy="13.3596" r="1.83385" fill="#C084FC" />
    <circle cx="16.6082" cy="18.1662" r="1.83385" fill="#C084FC" />
    <circle cx="22.1662" cy="18.1662" r="1.83385" fill="#C084FC" />
  </svg>
</template>
